...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.txtname.setText(model.getUsertitle());
        holder.txtprice.setText(model.getUserdescription());
//flow menu
...
//edit operation
                                ...
                                bundle.putString("title", model.getUsertitle());

                                bundle.putString("description", model.getUserdescription());
